-- Migration: Fix user_id types in charging tables (SAFE VERSION)
-- Date: 2025-10-28
...
-- Then use fix_charging_uuid_types.sql
...
-- Step 2: Recreate tables with correct UUID types
...
DO $$
BEGIN
    RAISE NOTICE '✅ Migration completed: Charging tables recreated with UUID types';
