...
function MyReservationsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6">
      ...
      {showQRModal && selectedReservationForQR && (
        selectedReservationForQR.type === 'parking' ? (
          <ReservationQRModal
            reservation={{
              ...selectedReservationForQR.originalData,
              parking_lot_name: selectedReservationForQR.name,
              address: selectedReservationForQR.address
            }}
          ...
          <ChargingSessionQRModal
            session={{
              ...selectedReservationForQR.originalData,
              station_name: selectedReservationForQR.name
            }}
            onClose={handleCloseQR}
          />
        )
